...
.method private a(ILandroid/support/v4/app/j;Ljava/lang/String;I)V
    ...
    iput-object v0, p2, Landroid/support/v4/app/j;->mFragmentManager:Landroid/support/v4/app/p;

    if-eqz p3, :cond_2

    iget-object v0, p2, Landroid/support/v4/app/j;->mTag:Ljava/lang/String;
    ...
    iget-object p2, p2, Landroid/support/v4/app/j;->mTag:Ljava/lang/String;
    ...
    :cond_3
    iget p3, p2, Landroid/support/v4/app/j;->mFragmentId:I
    ...
    iget p2, p2, Landroid/support/v4/app/j;->mFragmentId:I
    ...
    :cond_4
    iput p1, p2, Landroid/support/v4/app/j;->mFragmentId:I

    iput p1, p2, Landroid/support/v4/app/j;->mContainerId:I

    :cond_5
    new-instance p1, Landroid/support/v4/app/d$a;

    invoke-direct {p1, p4, p2}, Landroid/support/v4/app/d$a;-><init>(ILandroid/support/v4/app/j;)V
...
.method private static b(Landroid/support/v4/app/d$a;)Z
    ...
    iget-object p0, p0, Landroid/support/v4/app/d$a;->b:Landroid/support/v4/app/j;
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/j;->isPostponed()Z
...
.method a(Ljava/util/ArrayList;Landroid/support/v4/app/j;)Landroid/support/v4/app/j;
    .locals 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v4, v5, v1}, Landroid/support/v4/app/d$a;-><init>(ILandroid/support/v4/app/j;)V

    invoke-virtual {v3, p2, v4}, Ljava/util/ArrayList;->add(ILjava/lang/Object;)V

    add-int/lit8 p2, p2, 0x1

    iget-object v1, v2, Landroid/support/v4/app/d$a;->b:Landroid/support/v4/app/j;

    goto/16 :goto_5

    :pswitch_2
    iget-object v3, v2, Landroid/support/v4/app/d$a;->b:Landroid/support/v4/app/j;
    ...
    iget-object v2, v2, Landroid/support/v4/app/d$a;->b:Landroid/support/v4/app/j;

    invoke-direct {v3, v5, v2}, Landroid/support/v4/app/d$a;-><init>(ILandroid/support/v4/app/j;)V
    ...
    iget v7, v3, Landroid/support/v4/app/j;->mContainerId:I
    ...
    check-cast v10, Landroid/support/v4/app/j;
    ...
    invoke-direct {v11, v5, v10}, Landroid/support/v4/app/d$a;-><init>(ILandroid/support/v4/app/j;)V
    ...
    invoke-direct {v11, v12, v10}, Landroid/support/v4/app/d$a;-><init>(ILandroid/support/v4/app/j;)V
...
.method public a(ILandroid/support/v4/app/j;Ljava/lang/String;)Landroid/support/v4/app/u;
    .locals 1

    const/4 v0, 0x1

    invoke-direct {p0, p1, p2, p3, v0}, Landroid/support/v4/app/d;->a(ILandroid/support/v4/app/j;Ljava/lang/String;I)V

    return-object p0
.end method

.method public a(Landroid/support/v4/app/j;)Landroid/support/v4/app/u;
    .locals 2
    ...
    invoke-direct {v0, v1, p1}, Landroid/support/v4/app/d$a;-><init>(ILandroid/support/v4/app/j;)V
...
.method public a(Landroid/support/v4/app/j;Ljava/lang/String;)Landroid/support/v4/app/u;
    .locals 2
...
.method a(I)V
    ...
    iget v4, v3, Landroid/support/v4/app/j;->mBackStackNesting:I

    add-int/2addr v4, p1

    iput v4, v3, Landroid/support/v4/app/j;->mBackStackNesting:I
    ...
    iget-object v5, v2, Landroid/support/v4/app/d$a;->b:Landroid/support/v4/app/j;
    ...
    iget v2, v2, Landroid/support/v4/app/j;->mBackStackNesting:I
...
.method a(Landroid/support/v4/app/j$c;)V
    .locals 3
    ...
    iget-object v1, v1, Landroid/support/v4/app/d$a;->b:Landroid/support/v4/app/j;

    invoke-virtual {v1, p1}, Landroid/support/v4/app/j;->setOnStartEnterTransitionListener(Landroid/support/v4/app/j$c;)V
...
.method a(Ljava/util/ArrayList;II)Z
    ...
    iget-object v5, v4, Landroid/support/v4/app/d$a;->b:Landroid/support/v4/app/j;

    if-eqz v5, :cond_1

    iget-object v4, v4, Landroid/support/v4/app/d$a;->b:Landroid/support/v4/app/j;

    iget v4, v4, Landroid/support/v4/app/j;->mContainerId:I
    ...
    iget-object v9, v8, Landroid/support/v4/app/d$a;->b:Landroid/support/v4/app/j;

    if-eqz v9, :cond_2

    iget-object v8, v8, Landroid/support/v4/app/d$a;->b:Landroid/support/v4/app/j;

    iget v8, v8, Landroid/support/v4/app/j;->mContainerId:I
...
.method public a(Ljava/util/ArrayList;Ljava/util/ArrayList;)Z
    ...
    iget-object p1, p0, Landroid/support/v4/app/d;->a:Landroid/support/v4/app/p;

    invoke-virtual {p1, p0}, Landroid/support/v4/app/p;->b(Landroid/support/v4/app/d;)V
...
.method b(Ljava/util/ArrayList;Landroid/support/v4/app/j;)Landroid/support/v4/app/j;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :pswitch_0
    iget-object p2, v1, Landroid/support/v4/app/d$a;->b:Landroid/support/v4/app/j;
...
.method public b(Landroid/support/v4/app/j;)Landroid/support/v4/app/u;
    .locals 2
...
.method b(Z)V
    ...
    invoke-static {v4}, Landroid/support/v4/app/p;->d(I)I

    move-result v4

    iget v5, p0, Landroid/support/v4/app/d;->h:I

    invoke-virtual {v3, v4, v5}, Landroid/support/v4/app/j;->setNextTransition(II)V
    ...
    invoke-virtual {v4, v3}, Landroid/support/v4/app/p;->o(Landroid/support/v4/app/j;)V
    ...
    invoke-virtual {v4, v5}, Landroid/support/v4/app/p;->o(Landroid/support/v4/app/j;)V
    ...
    invoke-virtual {v3, v4}, Landroid/support/v4/app/j;->setNextAnim(I)V

    iget-object v4, p0, Landroid/support/v4/app/d;->a:Landroid/support/v4/app/p;

    invoke-virtual {v4, v3}, Landroid/support/v4/app/p;->k(Landroid/support/v4/app/j;)V
    ...
    invoke-virtual {v4, v3}, Landroid/support/v4/app/p;->l(Landroid/support/v4/app/j;)V
    ...
    invoke-virtual {v4, v3}, Landroid/support/v4/app/p;->i(Landroid/support/v4/app/j;)V
    ...
    invoke-virtual {v4, v3}, Landroid/support/v4/app/p;->j(Landroid/support/v4/app/j;)V
    ...
    invoke-virtual {v4, v3, v5}, Landroid/support/v4/app/p;->a(Landroid/support/v4/app/j;Z)V
    ...
    invoke-virtual {v4, v3}, Landroid/support/v4/app/p;->h(Landroid/support/v4/app/j;)V
    ...
    iget-object v2, p0, Landroid/support/v4/app/d;->a:Landroid/support/v4/app/p;

    invoke-virtual {v2, v3}, Landroid/support/v4/app/p;->e(Landroid/support/v4/app/j;)V
    ...
    iget v0, v0, Landroid/support/v4/app/p;->l:I
...
.method b(I)Z
    ...
    iget-object v4, v3, Landroid/support/v4/app/d$a;->b:Landroid/support/v4/app/j;

    if-eqz v4, :cond_0

    iget-object v3, v3, Landroid/support/v4/app/d$a;->b:Landroid/support/v4/app/j;

    iget v3, v3, Landroid/support/v4/app/j;->mContainerId:I
...
.method public c(Landroid/support/v4/app/j;)Landroid/support/v4/app/u;
    .locals 2
...
.method public e()V
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/d;->a()Landroid/support/v4/app/u;
...
.method g()V
    ...
    invoke-virtual {v5, v6, v7}, Landroid/support/v4/app/j;->setNextTransition(II)V
    ...
    :pswitch_0
    iget-object v6, p0, Landroid/support/v4/app/d;->a:Landroid/support/v4/app/p;

    const/4 v7, 0x0

    invoke-virtual {v6, v7}, Landroid/support/v4/app/p;->o(Landroid/support/v4/app/j;)V
    ...
    invoke-virtual {v6, v5}, Landroid/support/v4/app/p;->o(Landroid/support/v4/app/j;)V
    ...
    invoke-virtual {v5, v6}, Landroid/support/v4/app/j;->setNextAnim(I)V

    iget-object v6, p0, Landroid/support/v4/app/d;->a:Landroid/support/v4/app/p;

    invoke-virtual {v6, v5}, Landroid/support/v4/app/p;->l(Landroid/support/v4/app/j;)V
    ...
    invoke-virtual {v6, v5}, Landroid/support/v4/app/p;->k(Landroid/support/v4/app/j;)V
    ...
    invoke-virtual {v6, v5}, Landroid/support/v4/app/p;->j(Landroid/support/v4/app/j;)V
    ...
    invoke-virtual {v6, v5}, Landroid/support/v4/app/p;->i(Landroid/support/v4/app/j;)V
    ...
    invoke-virtual {v6, v5}, Landroid/support/v4/app/p;->h(Landroid/support/v4/app/j;)V
    ...
    invoke-virtual {v6, v5, v1}, Landroid/support/v4/app/p;->a(Landroid/support/v4/app/j;Z)V
    ...
    iget-object v3, p0, Landroid/support/v4/app/d;->a:Landroid/support/v4/app/p;

    invoke-virtual {v3, v5}, Landroid/support/v4/app/p;->e(Landroid/support/v4/app/j;)V
    ...
    iget v1, v1, Landroid/support/v4/app/p;->l:I
