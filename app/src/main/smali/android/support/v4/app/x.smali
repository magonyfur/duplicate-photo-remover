...
.method protected static a(Ljava/util/List;Landroid/view/View;)V
    ...
    invoke-static {p0, p1, v0}, Landroid/support/v4/app/x;->a(Ljava/util/List;Landroid/view/View;I)Z
    ...
    invoke-static {p0, v4, v0}, Landroid/support/v4/app/x;->a(Ljava/util/List;Landroid/view/View;I)Z
...
.method a(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Landroid/support/v4/view/s;->m(Landroid/view/View;)Ljava/lang/String;
...
.method a(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    :cond_3
    new-instance p5, Landroid/support/v4/app/x$1;
    ...
    invoke-direct/range {v0 .. v6}, Landroid/support/v4/app/x$1;-><init>(Landroid/support/v4/app/x;ILjava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;)V

    invoke-static {p1, p5}, Landroid/support/v4/app/ae;->a(Landroid/view/View;Ljava/lang/Runnable;)Landroid/support/v4/app/ae;
...
.method a(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-direct {v0, p0, p2, p3}, Landroid/support/v4/app/x$2;-><init>(Landroid/support/v4/app/x;Ljava/util/ArrayList;Ljava/util/Map;)V
...
.method a(Landroid/view/ViewGroup;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-direct {v0, p0, p2, p3}, Landroid/support/v4/app/x$3;-><init>(Landroid/support/v4/app/x;Ljava/util/ArrayList;Ljava/util/Map;)V
...
.method a(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1, v2}, Landroid/support/v4/app/x;->a(Ljava/util/ArrayList;Landroid/view/View;)V
...
.method a(Ljava/util/Map;Landroid/view/View;)V
    ...
    invoke-static {p2}, Landroid/support/v4/view/s;->m(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v2}, Landroid/support/v4/app/x;->a(Ljava/util/Map;Landroid/view/View;)V
