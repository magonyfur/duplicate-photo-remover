...
.method private b(Landroid/graphics/drawable/Drawable;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/h;->f:Landroid/support/v7/widget/bf;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/h;->f:Landroid/support/v7/widget/bf;
    ...
    invoke-static {v1}, Landroid/support/v4/view/s;->s(Landroid/view/View;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1}, Landroid/support/v4/view/s;->t(Landroid/view/View;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v1

    if-eqz v1, :cond_2

    iput-boolean v2, v0, Landroid/support/v7/widget/bf;->c:Z

    iput-object v1, v0, Landroid/support/v7/widget/bf;->b:Landroid/graphics/PorterDuff$Mode;

    :cond_2
    iget-boolean v1, v0, Landroid/support/v7/widget/bf;->d:Z

    if-nez v1, :cond_4

    iget-boolean v1, v0, Landroid/support/v7/widget/bf;->c:Z
    ...
    invoke-static {p1, v0, v1}, Landroid/support/v7/widget/m;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bf;[I)V
...
.method private d()Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/h;->d:Landroid/support/v7/widget/bf;
...
.method a()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/h;->e:Landroid/support/v7/widget/bf;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/h;->e:Landroid/support/v7/widget/bf;
    ...
    iget-object p1, p0, Landroid/support/v7/widget/h;->e:Landroid/support/v7/widget/bf;

    const/4 v0, 0x1

    iput-boolean v0, p1, Landroid/support/v7/widget/bf;->d:Z
...
.method a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-boolean v0, p1, Landroid/support/v7/widget/bf;->c:Z
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p1, p2}, Landroid/support/v7/widget/bh;->g(I)Z
    ...
    invoke-virtual {p1, v1}, Landroid/support/v7/widget/bh;->e(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p1, v1, v0}, Landroid/support/v7/widget/bh;->a(II)I
...
.method b(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/h;->d:Landroid/support/v7/widget/bf;
    ...
    iget-object p1, p0, Landroid/support/v7/widget/h;->d:Landroid/support/v7/widget/bf;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/h;->d:Landroid/support/v7/widget/bf;
...
.method c()V
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/h;->e:Landroid/support/v7/widget/bf;
    ...
    invoke-static {v0, v1, v2}, Landroid/support/v7/widget/m;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bf;[I)V

    return-void

    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/h;->d:Landroid/support/v7/widget/bf;
