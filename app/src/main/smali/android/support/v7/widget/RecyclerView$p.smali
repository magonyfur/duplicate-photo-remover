...
.method private e(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    iget-object p1, p1, Landroid/support/v7/widget/RecyclerView;->G:Landroid/support/v7/widget/av;

    invoke-virtual {p1}, Landroid/support/v7/widget/av;->b()Landroid/support/v4/view/b;
...
.method b(IZ)Landroid/support/v7/widget/RecyclerView$x;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/ae;
    ...
    iget-object p2, p2, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/ae;
    ...
    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/ae;
...
.method b(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    iget-object v5, v5, Landroid/support/v7/widget/RecyclerView;->B:Landroid/support/v7/widget/an$a;
    ...
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/bo;

    invoke-virtual {v2, p1}, Landroid/support/v7/widget/bo;->g(Landroid/support/v7/widget/RecyclerView$x;)V
...
.method d()V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView;->B:Landroid/support/v7/widget/an$a;
...
.method d(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/bo;->g(Landroid/support/v7/widget/RecyclerView$x;)V
