...
.method protected static a(Landroid/content/Context;Landroid/support/v7/widget/m;I)Landroid/support/v7/widget/bf;
    .locals 0
    ...
    new-instance p1, Landroid/support/v7/widget/bf;

    invoke-direct {p1}, Landroid/support/v7/widget/bf;-><init>()V

    const/4 p2, 0x1

    iput-boolean p2, p1, Landroid/support/v7/widget/bf;->d:Z

    iput-object p0, p1, Landroid/support/v7/widget/bf;->a:Landroid/content/res/ColorStateList;
...
.method private a(Landroid/content/Context;Landroid/support/v7/widget/bh;)V
    ...
    invoke-virtual {p2, p1, v1}, Landroid/support/v7/widget/bh;->a(II)I
    ...
    invoke-virtual {p2, v0, p1, v3}, Landroid/support/v7/widget/bh;->a(IILandroid/support/v4/a/a/b$a;)Landroid/graphics/Typeface;
...
.method a()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/aa;->b:Landroid/support/v7/widget/bf;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/aa;->c:Landroid/support/v7/widget/bf;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/aa;->d:Landroid/support/v7/widget/bf;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/aa;->e:Landroid/support/v7/widget/bf;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/aa;->b:Landroid/support/v7/widget/bf;

    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/aa;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bf;)V

    const/4 v1, 0x1

    aget-object v1, v0, v1

    iget-object v2, p0, Landroid/support/v7/widget/aa;->c:Landroid/support/v7/widget/bf;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/aa;->d:Landroid/support/v7/widget/bf;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/aa;->e:Landroid/support/v7/widget/bf;

    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/aa;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bf;)V
...
.method a(Landroid/content/Context;I)V
    ...
    invoke-virtual {p2, v0, v1}, Landroid/support/v7/widget/bh;->a(IZ)Z
    ...
    invoke-virtual {p2, v0}, Landroid/support/v7/widget/bh;->e(I)Landroid/content/res/ColorStateList;
    ...
    :cond_1
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/aa;->a(Landroid/content/Context;Landroid/support/v7/widget/bh;)V
...
.method final a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bf;)V
    ...
    invoke-static {p1, p2, v0}, Landroid/support/v7/widget/m;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bf;[I)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, p1, v2, p2, v3}, Landroid/support/v7/widget/bh;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bh;
    ...
    invoke-virtual {v2, v4, v5}, Landroid/support/v7/widget/bh;->g(II)I

    move-result v4

    sget v6, Landroid/support/v7/a/a$j;->AppCompatTextHelper_android_drawableLeft:I

    invoke-virtual {v2, v6}, Landroid/support/v7/widget/bh;->g(I)Z
    ...
    invoke-virtual {v2, v6, v3}, Landroid/support/v7/widget/bh;->g(II)I

    move-result v6

    invoke-static {v0, v1, v6}, Landroid/support/v7/widget/aa;->a(Landroid/content/Context;Landroid/support/v7/widget/m;I)Landroid/support/v7/widget/bf;

    move-result-object v6

    iput-object v6, p0, Landroid/support/v7/widget/aa;->b:Landroid/support/v7/widget/bf;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/aa;->c:Landroid/support/v7/widget/bf;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/aa;->d:Landroid/support/v7/widget/bf;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/aa;->e:Landroid/support/v7/widget/bf;
    ...
    invoke-static {v0, v4, v5}, Landroid/support/v7/widget/bh;->a(Landroid/content/Context;I[I)Landroid/support/v7/widget/bh;
    ...
    invoke-virtual {v4, v5}, Landroid/support/v7/widget/bh;->g(I)Z
    ...
    invoke-virtual {v4, v5, v3}, Landroid/support/v7/widget/bh;->a(IZ)Z
    ...
    :goto_0
    invoke-direct {p0, v0, v4}, Landroid/support/v7/widget/aa;->a(Landroid/content/Context;Landroid/support/v7/widget/bh;)V
    ...
    invoke-virtual {v4, v9}, Landroid/support/v7/widget/bh;->g(I)Z
    ...
    invoke-virtual {v4, v9}, Landroid/support/v7/widget/bh;->e(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v4, v10}, Landroid/support/v7/widget/bh;->g(I)Z
    ...
    invoke-virtual {v4, v10}, Landroid/support/v7/widget/bh;->e(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v4, v11}, Landroid/support/v7/widget/bh;->g(I)Z
    ...
    invoke-virtual {v4, v7}, Landroid/support/v7/widget/bh;->e(I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v0, p1, v4, p2, v3}, Landroid/support/v7/widget/bh;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bh;
    ...
    invoke-virtual {v4, v2}, Landroid/support/v7/widget/bh;->g(I)Z
    ...
    invoke-virtual {v4, v2}, Landroid/support/v7/widget/bh;->e(I)Landroid/content/res/ColorStateList;
