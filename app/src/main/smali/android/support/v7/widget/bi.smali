...
.method public constructor <init>(Landroid/support/v7/widget/Toolbar;ZII)V
    ...
    iput p4, p0, Landroid/support/v7/widget/bi;->o:I

    iput p4, p0, Landroid/support/v7/widget/bi;->p:I
    ...
    invoke-static {p1, v0, v1, v2, p4}, Landroid/support/v7/widget/bh;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bh;

    move-result-object p1

    sget v0, Landroid/support/v7/a/a$j;->ActionBar_homeAsUpIndicator:I

    invoke-virtual {p1, v0}, Landroid/support/v7/widget/bh;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/bi;->b(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/bi;->c(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/bi;->c(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/bi;->a(Landroid/graphics/drawable/Drawable;)V

    :cond_4
    iget-object p2, p0, Landroid/support/v7/widget/bi;->j:Landroid/graphics/drawable/Drawable;

    if-nez p2, :cond_5

    iget-object p2, p0, Landroid/support/v7/widget/bi;->q:Landroid/graphics/drawable/Drawable;

    if-eqz p2, :cond_5

    iget-object p2, p0, Landroid/support/v7/widget/bi;->q:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p0, p2}, Landroid/support/v7/widget/bi;->b(Landroid/graphics/drawable/Drawable;)V

    :cond_5
    sget p2, Landroid/support/v7/a/a$j;->ActionBar_displayOptions:I

    invoke-virtual {p1, p2, p4}, Landroid/support/v7/widget/bh;->a(II)I

    move-result p2

    invoke-virtual {p0, p2}, Landroid/support/v7/widget/bi;->c(I)V

    sget p2, Landroid/support/v7/a/a$j;->ActionBar_customNavigationLayout:I

    invoke-virtual {p1, p2, p4}, Landroid/support/v7/widget/bh;->g(II)I
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/bi;->a(Landroid/view/View;)V

    iget p2, p0, Landroid/support/v7/widget/bi;->e:I
    ...
    invoke-virtual {p1, p2, p4}, Landroid/support/v7/widget/bh;->f(II)I
    ...
    iget-object p2, p0, Landroid/support/v7/widget/bi;->a:Landroid/support/v7/widget/Toolbar;
    ...
    invoke-virtual {p1, p2, v0}, Landroid/support/v7/widget/bh;->d(II)I

    move-result p2

    sget v1, Landroid/support/v7/a/a$j;->ActionBar_contentInsetEnd:I

    invoke-virtual {p1, v1, v0}, Landroid/support/v7/widget/bh;->d(II)I
    ...
    iget-object p4, p0, Landroid/support/v7/widget/bi;->a:Landroid/support/v7/widget/Toolbar;
    ...
    :cond_c
    invoke-direct {p0}, Landroid/support/v7/widget/bi;->r()I

    move-result p2

    iput p2, p0, Landroid/support/v7/widget/bi;->e:I

    :cond_d
    :goto_1
    invoke-virtual {p1}, Landroid/support/v7/widget/bh;->a()V

    invoke-virtual {p0, p3}, Landroid/support/v7/widget/bi;->g(I)V

    iget-object p1, p0, Landroid/support/v7/widget/bi;->a:Landroid/support/v7/widget/Toolbar;
    ...
    new-instance p2, Landroid/support/v7/widget/bi$1;

    invoke-direct {p2, p0}, Landroid/support/v7/widget/bi$1;-><init>(Landroid/support/v7/widget/bi;)V
...
.method private t()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/bi;->j:Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/bi;->q:Landroid/graphics/drawable/Drawable;
...
.method public a(IJ)Landroid/support/v4/view/w;
    ...
    new-instance p3, Landroid/support/v7/widget/bi$2;

    invoke-direct {p3, p0, p1}, Landroid/support/v7/widget/bi$2;-><init>(Landroid/support/v7/widget/bi;I)V
...
.method public a(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/bi;->a(Landroid/graphics/drawable/Drawable;)V
...
.method public a(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {p0}, Landroid/support/v7/widget/bi;->s()V
...
.method public a(Landroid/view/View;)V
    ...
    iget p1, p0, Landroid/support/v7/widget/bi;->e:I
...
.method public b(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/bi;->c(Landroid/graphics/drawable/Drawable;)V
...
.method public d(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/bi;->b(Landroid/graphics/drawable/Drawable;)V
...
.method public e(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/bi;->d(Ljava/lang/CharSequence;)V
...
.method public g(I)V
    ...
    iget p1, p0, Landroid/support/v7/widget/bi;->p:I

    invoke-virtual {p0, p1}, Landroid/support/v7/widget/bi;->e(I)V
