...
.method constructor <init>(Landroid/support/v7/widget/bn$b;)V
    ...
    new-instance p1, Landroid/support/v7/widget/bn$a;

    invoke-direct {p1}, Landroid/support/v7/widget/bn$a;-><init>()V

    iput-object p1, p0, Landroid/support/v7/widget/bn;->b:Landroid/support/v7/widget/bn$a;
...
.method a(IIII)Landroid/view/View;
    ...
    invoke-interface {v1}, Landroid/support/v7/widget/bn$b;->b()I
    ...
    invoke-interface {v4, p1}, Landroid/support/v7/widget/bn$b;->a(I)Landroid/view/View;

    move-result-object v4

    iget-object v5, p0, Landroid/support/v7/widget/bn;->a:Landroid/support/v7/widget/bn$b;

    invoke-interface {v5, v4}, Landroid/support/v7/widget/bn$b;->a(Landroid/view/View;)I

    move-result v5

    iget-object v6, p0, Landroid/support/v7/widget/bn;->a:Landroid/support/v7/widget/bn$b;

    invoke-interface {v6, v4}, Landroid/support/v7/widget/bn$b;->b(Landroid/view/View;)I

    move-result v6

    iget-object v7, p0, Landroid/support/v7/widget/bn;->b:Landroid/support/v7/widget/bn$a;

    invoke-virtual {v7, v0, v1, v5, v6}, Landroid/support/v7/widget/bn$a;->a(IIII)V

    if-eqz p3, :cond_1

    iget-object v5, p0, Landroid/support/v7/widget/bn;->b:Landroid/support/v7/widget/bn$a;

    invoke-virtual {v5}, Landroid/support/v7/widget/bn$a;->a()V
    ...
    invoke-virtual {v5}, Landroid/support/v7/widget/bn$a;->b()Z
...
.method a(Landroid/view/View;I)Z
    ...
    invoke-virtual {v0, v1, v2, v3, p1}, Landroid/support/v7/widget/bn$a;->a(IIII)V

    if-eqz p2, :cond_0

    iget-object p1, p0, Landroid/support/v7/widget/bn;->b:Landroid/support/v7/widget/bn$a;

    invoke-virtual {p1}, Landroid/support/v7/widget/bn$a;->a()V

    iget-object p1, p0, Landroid/support/v7/widget/bn;->b:Landroid/support/v7/widget/bn$a;

    invoke-virtual {p1, p2}, Landroid/support/v7/widget/bn$a;->a(I)V

    iget-object p1, p0, Landroid/support/v7/widget/bn;->b:Landroid/support/v7/widget/bn$a;

    invoke-virtual {p1}, Landroid/support/v7/widget/bn$a;->b()Z
