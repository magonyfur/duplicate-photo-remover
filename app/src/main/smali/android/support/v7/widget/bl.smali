...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Landroid/support/v7/widget/bl;->f:[I
    ...
    iget-object p1, p0, Landroid/support/v7/widget/bl;->a:Landroid/content/Context;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/bl;->b:Landroid/view/View;

    iget-object p1, p0, Landroid/support/v7/widget/bl;->b:Landroid/view/View;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/bl;->c:Landroid/widget/TextView;

    iget-object p1, p0, Landroid/support/v7/widget/bl;->d:Landroid/view/WindowManager$LayoutParams;
...
.method private a(Landroid/view/View;IIZLandroid/view/WindowManager$LayoutParams;)V
    ...
    :cond_3
    iget-object v4, p0, Landroid/support/v7/widget/bl;->e:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/bl;->a:Landroid/content/Context;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/bl;->e:Landroid/graphics/Rect;
    ...
    :cond_5
    iget-object v4, p0, Landroid/support/v7/widget/bl;->g:[I

    invoke-virtual {v3, v4}, Landroid/view/View;->getLocationOnScreen([I)V

    iget-object v4, p0, Landroid/support/v7/widget/bl;->f:[I

    invoke-virtual {p1, v4}, Landroid/view/View;->getLocationOnScreen([I)V

    iget-object p1, p0, Landroid/support/v7/widget/bl;->f:[I

    aget v4, p1, v2

    iget-object v5, p0, Landroid/support/v7/widget/bl;->g:[I
    ...
    iget-object p2, p0, Landroid/support/v7/widget/bl;->b:Landroid/view/View;
    ...
    iget-object p2, p0, Landroid/support/v7/widget/bl;->f:[I
    ...
    iget-object p3, p0, Landroid/support/v7/widget/bl;->f:[I
    ...
    iget-object p4, p0, Landroid/support/v7/widget/bl;->e:Landroid/graphics/Rect;
...
.method a()V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/bl;->b()Z
...
.method a(Landroid/view/View;IIZLjava/lang/CharSequence;)V
    ...
    iget-object v6, p0, Landroid/support/v7/widget/bl;->d:Landroid/view/WindowManager$LayoutParams;
    ...
    invoke-direct/range {v1 .. v6}, Landroid/support/v7/widget/bl;->a(Landroid/view/View;IIZLandroid/view/WindowManager$LayoutParams;)V
    ...
    iget-object p3, p0, Landroid/support/v7/widget/bl;->d:Landroid/view/WindowManager$LayoutParams;
