...
.method private constructor <init>(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/bk;->a:Landroid/view/View;
...
.method static synthetic a(Landroid/support/v7/widget/bk;Z)V
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/bk;->a(Z)V
...
.method public static a(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    sget-object p1, Landroid/support/v7/widget/bk;->j:Landroid/support/v7/widget/bk;

    if-eqz p1, :cond_1

    sget-object p1, Landroid/support/v7/widget/bk;->j:Landroid/support/v7/widget/bk;

    iget-object p1, p1, Landroid/support/v7/widget/bk;->a:Landroid/view/View;

    if-ne p1, p0, :cond_1

    sget-object p1, Landroid/support/v7/widget/bk;->j:Landroid/support/v7/widget/bk;

    invoke-direct {p1}, Landroid/support/v7/widget/bk;->a()V
...
.method private a(Z)V
    ...
    invoke-direct {p1, v0}, Landroid/support/v7/widget/bl;-><init>(Landroid/content/Context;)V

    iput-object p1, p0, Landroid/support/v7/widget/bk;->g:Landroid/support/v7/widget/bl;

    iget-object v1, p0, Landroid/support/v7/widget/bk;->g:Landroid/support/v7/widget/bl;

    iget-object v2, p0, Landroid/support/v7/widget/bk;->a:Landroid/view/View;

    iget v3, p0, Landroid/support/v7/widget/bk;->e:I

    iget v4, p0, Landroid/support/v7/widget/bk;->f:I

    iget-boolean v5, p0, Landroid/support/v7/widget/bk;->h:Z

    iget-object v6, p0, Landroid/support/v7/widget/bk;->b:Ljava/lang/CharSequence;

    invoke-virtual/range {v1 .. v6}, Landroid/support/v7/widget/bl;->a(Landroid/view/View;IIZLjava/lang/CharSequence;)V

    iget-object p1, p0, Landroid/support/v7/widget/bk;->a:Landroid/view/View;

    invoke-virtual {p1, p0}, Landroid/view/View;->addOnAttachStateChangeListener(Landroid/view/View$OnAttachStateChangeListener;)V

    iget-boolean p1, p0, Landroid/support/v7/widget/bk;->h:Z
    ...
    invoke-static {p1}, Landroid/support/v4/view/s;->n(Landroid/view/View;)I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/bk;->d:Ljava/lang/Runnable;
...
.method private static b(Landroid/support/v7/widget/bk;)V
    ...
    sget-object p0, Landroid/support/v7/widget/bk;->i:Landroid/support/v7/widget/bk;
...
.method public onHover(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget-object p1, p0, Landroid/support/v7/widget/bk;->g:Landroid/support/v7/widget/bl;
    ...
    iput p1, p0, Landroid/support/v7/widget/bk;->f:I
